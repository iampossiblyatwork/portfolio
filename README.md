...
## To verify before going public
- [ ] Confirm/replace descriptions for private projects (Airport Calculator, Dividend Optimizer, RentCast Analyzer).
- [ ] Decide how to attribute **Career-Ops** (self-hosted / fork) or remove it.
- [ ] Add **Live** links once apps are deployed.
- [ ] Swap social/contact handles if needed.
